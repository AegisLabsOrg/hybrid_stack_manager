...
struct NativeRouteArgs {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NativeRouteArgs? {
    let routeName: String? = nilOrValue(pigeonVar_list[0])
...
private class MessagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    switch type {
    case 129:
      return NativeRouteArgs.fromList(self.readValue() as! [Any?])
    default:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? NativeRouteArgs {
      super.writeByte(129)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NativeStackApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      pushNativeRouteChannel.setMessageHandler { message, reply in
        ...
        let argsArg = args[0] as! NativeRouteArgs
        do {
          try api.pushNativeRoute(args: argsArg)
...
protocol FlutterStackApiProtocol {
...
class FlutterStackApi: FlutterStackApiProtocol {
